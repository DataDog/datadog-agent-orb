Install() {
    ...
    DD_API_KEY=${PARAM_DD_API_KEY} DD_AGENT_MAJOR_VERSION=${PARAM_DD_AGENT_MAJOR_VERSION} DD_AGENT_MINOR_VERSION=${PARAM_DD_AGENT_MINOR_VERSION} DD_SITE=${PARAM_DD_SITE} \
